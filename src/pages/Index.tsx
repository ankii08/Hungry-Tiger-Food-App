...
const Index = () => {
  ...
  useEffect(() => {
    const preloadImages = () => {
      const imageUrls = [
        '/uploads/0ae562c5-5c88-4c2d-97cd-7d89c980721a.png', // Form screen tiger
        '/uploads/0665048e-ad40-4530-b849-0390b3667650.png', // Password screen tiger
        '/uploads/fc82ea5e-3e13-4240-8f8c-b4469c2153c4.png', // Location screen tiger
        '/uploads/4e2f3f60-20d2-4179-a8c3-d01aaedd6fb1.png', // Avatar screen tiger
        '/uploads/bb95d81e-f824-4762-aed3-c6fb2af3cfba.png'  // Completion screen tiger
      ];
